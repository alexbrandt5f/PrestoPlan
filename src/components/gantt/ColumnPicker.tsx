...
const ACTIVITY_FIELDS: AvailableField[] = [
  ...
  { id: 'original_duration_hours', label: 'Original Duration (days)', field: 'original_duration_hours', dataType: 'number', source: 'activity' },
  { id: 'remaining_duration_hours', label: 'Remaining Duration (days)', field: 'remaining_duration_hours', dataType: 'number', source: 'activity' },
  { id: 'actual_duration_hours', label: 'Actual Duration (days)', field: 'actual_duration_hours', dataType: 'number', source: 'activity' },
  ...
  { id: 'total_float_hours', label: 'Total Float (days)', field: 'total_float_hours', dataType: 'number', source: 'activity' },
  { id: 'free_float_hours', label: 'Free Float (days)', field: 'free_float_hours', dataType: 'number', source: 'activity' },
